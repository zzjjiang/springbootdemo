...
//config的设置是全局的
layui.config({
    base: '/js/util/' //这是你存放拓展模块的根目录
}).use(['bodyTab', 'form', 'colorpicker', 'jquery'], function () {
    ...
    $(".signOut").click(function (event) {
        ...
        layui.layer.load(2, {
            shade: [0.9, '#FFF'],
            content: '<div style="width:100px;line-height:32px;text-align:right;">正在退出...</div>'
        });
    ...
    showNotice = function() {
        layer.open({
            ...
            moveType: 1,
            content:
                '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>基于layui开发的一套纯前端后台框架，后面可替换成我们平台的公告</p></div>',
